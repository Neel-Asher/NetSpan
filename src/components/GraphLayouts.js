...
export function applyForceDirectedLayout(nodes, edges, options, iterations = 100) {
...
export function applyCircularLayout(nodes, options) {
    const { width, height, padding = 50 } = options;
...
export function applyLayout(nodes, edges, layoutType, options) {
    switch (layoutType) {
        case 'circular':
            return applyCircularLayout(nodes, options);
        case 'force-directed':
